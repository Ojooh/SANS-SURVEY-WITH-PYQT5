...
class Ui_surveyWindow(object):
        ...
        def start(self):
                ...
                self.questionLabel_2.setText("<html><head/><body><p><span style=\" font-size:12pt;\">"+ "1. " + free["1."]";,</span></p></body></html>")
        ...
        def nextQuestion(self):
                ...
                if len(gee) == 0:
                        ...
                        y = str(gee[0]) + "."
                        index = gee[0] - 1
                        self.questionLabel_2.setText("<html><head/><body><p><span style=\" font-size:12pt;\">"+y + free[y]+";,</span></p></body></html>")
